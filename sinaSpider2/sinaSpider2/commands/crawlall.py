...
class Command(ScrapyCommand):
	...
	def add_options(self,parser):
		...
		parser.add_option('-o','--output',metavar='FILE',help='dump scraped items into FILE(user - for stdout)')
	...
	def process_options(self,args,opts):
		...
		try:
			...
			raise UsageError('Invalid -a value, use -a Name=VALUE',print_hlpe=False)
